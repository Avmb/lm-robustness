...
parser.add_argument('--rnd_disable_state_post_proc_pre_update', action='store_true',
                    help='skip OOD scaling on state update')     
parser.add_argument('--rnd_state_proc_only_on_last_layer', action='store_true',
                    help='apply OOD scaling only on the last RNN layer') 
...
model.state_post_proc_pre_update=not args.rnd_disable_state_post_proc_pre_update
model.state_proc_only_on_last_layer = args.rnd_state_proc_only_on_last_layer
